...
%%
    ...
    if length(waveform) > 4e5
        
    else
        [ waveformDDPlus, waveformDD ] = doubleDerive(waveform, fs );
        ...
        if verbose
            ...
            plot(newTime, waveform);
            plot(newTime(footIndex), waveform(footIndex),'<','color', Colors(4,:), 'markerfacecolor',Colors(4,:))
